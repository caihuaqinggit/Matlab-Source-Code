...
% pick the month we want. Here we use March-September inclusive
month1 = 3;
month2 = 9;

% all year Here we use JAN-DEC inclusive
%month1 = 1;
%month2 = 12;

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% List of low-event years we want to do statistics:
% These are the true low years. The earlier ones are the years that we have NARR analysis
%%%%%%%% 1952 1950 1951 1953 1963 1956 1955 1969 2002 1954
years = {'1952','1950','1951','1953','1963','1956','1955','1969','2002','1954'}; 
nyears = 10;    % 10 years of low-event
...
%F0C = conv2(F0,Filter,'same')*2;
%F1C = conv2(F1,Filter,'same')*2;
%F2C = conv2(F2,Filter,'same')*2;
%F3C = conv2(F3,Filter,'same')*2;
%F4C = conv2(F4,Filter,'same')*2;
%F5C = conv2(F5,Filter,'same')*2;
% Start make plots
...
jpgfile='F0_low_t.jpg';
print (1,'-djpeg95','-r100', jpgfile);

epsfile='F0_low_t.eps';
...
jpgfile='F1_low_t.jpg';
print (1,'-djpeg95','-r100', jpgfile);

epsfile='F1_low_t.eps';
print (1, '-depsc2', epsfile);
...
jpgfile='F2_low_t.jpg';
print (1,'-djpeg95','-r100', jpgfile);

epsfile='F2_low_t.eps';
print (1, '-depsc2', epsfile);
...
jpgfile='F3_low_t.jpg';
print (1,'-djpeg95','-r100', jpgfile);

epsfile='F3_low_t.eps';
print (1, '-depsc2', epsfile);
...
jpgfile='F4_low_t.jpg';
print (1,'-djpeg95','-r100', jpgfile);

epsfile='F4_low_t.eps';
print (1, '-depsc2', epsfile);
...
jpgfile='F5_low_t.jpg';
print (1,'-djpeg95','-r100', jpgfile);

epsfile='F5_low_t.eps';
print (1, '-depsc2', epsfile);
