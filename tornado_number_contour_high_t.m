...
% List of high-event years we want to do statistics: These are the true high
% yeas without considering whether or not we have reanalysis data
% 1990 1998 1980 1992 1977 1982 2004 1973 2008 2011

years = {'1990','1998','1980','1992','1977','1982','2004','1973','2008','2011'}; 
...
jpgfile='F0_high_t.jpg';
print (1,'-djpeg95','-r100', jpgfile);

epsfile='F0_high_t.eps';
...
jpgfile='F1_high_t.jpg';
print (1,'-djpeg95','-r100', jpgfile);

epsfile='F1_high_t.eps';
print (1, '-depsc2', epsfile);
...
jpgfile='F2_high_t.jpg';
print (1,'-djpeg95','-r100', jpgfile);

epsfile='F2_high_t.eps';
print (1, '-depsc2', epsfile);
...
jpgfile='F3_high_t.jpg';
print (1,'-djpeg95','-r100', jpgfile);

epsfile='F3_high_t.eps';
print (1, '-depsc2', epsfile);
...
jpgfile='F4_high_t.jpg';
print (1,'-djpeg95','-r100', jpgfile);

epsfile='F4_high_t.eps';
print (1, '-depsc2', epsfile);
...
jpgfile='F5_high_t.jpg';
print (1,'-djpeg95','-r100', jpgfile);

epsfile='F5_high_t.eps';
print (1, '-depsc2', epsfile);
