...
% List of low-event years we want to do statistics. Notice that similar to
% high event years, there are not always 10 years for F1, .. F5 tornadoes

%%%% F1 %%%%%%
%years = {'2002','1987','2012','1985','2000','1986','1994','1997','2001','1995'}; 
%nyears = 10;    % 10 years of low-event

%%%% F2 %%%%%%
%years = {'2000','1987','2015','2002','2014','1988','1993','1985','2013','1994'}; 
%nyears = 10;    % 10 years of low-event

%%%% F3 %%%%%%
%years = {'1989','1987','2015','2013','1995','1996','2000','2005','2009','2014'}; 
%nyears = 10;    % 10 years of low-event

%%%% F4 %%%%%%
%years = {'2005','1996','2006','2009','1987','1986','1988','2000','2015','1983'}; 
%nyears = 10;    % 10 years of low-event

%%%% F5 %%%%%%
years = {'1980','1981','1983','1986','1987','1988','1989','1993','1994','1995'}; 
nyears = 10;    % 10 years of low-event
