...
% 1987, 2002, 2000, 2012, 1985, 1994, 1997, 2001, 1988, and 1986
years = {'1987','2002','2000','2012','1985','1994','1997','2001','1988','1986'}; 
...
jpgfile='F1F4_low.jpg';
print (1,'-djpeg95','-r100', jpgfile);

epsfile='F1F4_low.eps';
print (1, '-depsc2', epsfile);
...
jpgfile='F3F5_low.jpg';
print (1,'-djpeg95','-r100', jpgfile);

epsfile='F3F5_low.eps';
print (1, '-depsc2', epsfile);
