...
% List of low-event years we want to do statistics:2002, 1987, 2012, 1985, 2000, 1986, 1994, 1997, 2001, 1995
...
title('F0_low Tornadoes','fontsize',14,'fontweight','bold');
xlabel('Lon');
ylabel('Lat');
...
axis([lon1 lon2 lat1 lat2]);
title('F1_low Tornadoes','fontsize',14,'fontweight','bold');
xlabel('Lon');
ylabel('Lat');
...
axis([lon1 lon2 lat1 lat2]);
title('F2_low Tornadoes','fontsize',14,'fontweight','bold');
xlabel('Lon');
ylabel('Lat');
...
axis([lon1 lon2 lat1 lat2]);
title('F3_low Tornadoes','fontsize',14,'fontweight','bold');
xlabel('Lon');
ylabel('Lat');
...
axis([lon1 lon2 lat1 lat2]);
title('F4_low Tornadoes','fontsize',14,'fontweight','bold');
xlabel('Lon');
ylabel('Lat');
...
axis([lon1 lon2 lat1 lat2]);
title('F5_low Tornadoes','fontsize',14,'fontweight','bold');
xlabel('Lon');
ylabel('Lat');
