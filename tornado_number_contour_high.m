...
% List of high-event years we want to do statistics. Here high years are different for F1, F2
% F3, and F4 tornadoes, so we have them listed here:
%%% F1  %%%%%%
%years = {'2011','2008','2004','1982','1992','1980','2015','1998','1990','1983'};
%nyears = 10;    % 10 years of high-event for F1

%%% F2  %%%%%%
%years = {'2011','1982','1980','1990','2008','1981','1983'};
%nyears = 7;    % 7 years of high-event for F2

%%% F3  %%%%%%
%years = {'2011','1982','1983','1999','2008','1990','1992','1991'};
%nyears = 8;    % 8 years of high-event for F3


%%% F4  %%%%%%
%years = {'2011','1984','2010','1992','1999','1995','1990','1989','2008','1997'};
%nyears = 10;    % 10 years of high-event for F4

%%% F5  %%%%%%
years = {'2011','1990','1998','2013','2008','2007','1999','1997','1996','1992'};
nyears = 10;    % 10 years of high-event for F5
